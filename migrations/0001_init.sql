-- Migration 0001: initial schema. Mirrors ../schema.sql exactly — kept in
-- sync manually since D1 migrations are additive/forward-only. Apply with:
--   npx wrangler d1 migrations apply pulse-vibe-demo --remote
-- (or --local for dev). See ../schema.sql for column-level comments.
